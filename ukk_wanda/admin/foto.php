        ...
        <div class="card mt-2">
          ...
          <div class="card-body">
            <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
              ...
              <input type="file" class="form-control" name="lokasifoto" required>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                while($data = mysqli_fetch_array($sql)) {
                  ...
                  <tr>
                    <td> <?php echo $no++ ?> </td>
                    <td> <img src="../assets/img/<?php echo $data['lokasifoto'] ?>" width="100"></td>
                            ...
                            <div class="modal-body">
                              <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                  ...
                                  <img src="../assets/img/<?php echo $data['lokasifoto'] ?>" width="100">
